...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-mini"><b><?php echo htmlspecialchars( $sist, ENT_COMPAT, 'UTF-8', FALSE ); ?></b><?php echo htmlspecialchars( $sisname, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b><?php echo htmlspecialchars( $sistem, ENT_COMPAT, 'UTF-8', FALSE ); ?></b><?php echo htmlspecialchars( $sisname, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><strong><?php echo toUppercase($name); ?></strong></span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/categories"><i class="fa fa-sitemap"></i> <span>Categorias</span></a></li>
